                ...
                <div class="mega-menu-content" style="max-width: 1400px; margin: 0 auto; padding: 30px 40px;">
                    ...
                    <div class="grid grid-cols-5 gap-10" style="display: grid; grid-template-columns: repeat(5, 1fr); gap: 2.5rem;">
                        ...
                        <div class="mega-menu-column" style="border-right: 1px solid #333; padding-right: 2rem;">
                            <h4 style="font-size: 14px; font-weight: 600; text-transform: uppercase; color: #ff6b35; margin-bottom: 12px;">Editing & Assembly</h4>
                            <ul>
                        ...
                        <div class="mega-menu-column" style="border-right: 1px solid #333; padding-right: 2rem;">
                            <h4 style="font-size: 14px; font-weight: 600; text-transform: uppercase; color: #ff6b35; margin-bottom: 12px;">Color & Visual Finishing</h4>
                            <ul>
                        ...
                        <!-- Motion & VFX -->
                        <div class="mega-menu-column" style="border-right: 1px solid #333; padding-right: 2rem;">
                            <h4 style="font-size: 14px; font-weight: 600; text-transform: uppercase; color: #ff6b35; margin-bottom: 12px;">Motion & VFX</h4>
                            <ul>
                        ...
                        <!-- Audio Post -->
                        <div class="mega-menu-column" style="border-right: 1px solid #333; padding-right: 2rem;">
                            <h4 style="font-size: 14px; font-weight: 600; text-transform: uppercase; color: #ff6b35; margin-bottom: 12px;">Audio Post</h4>
                            <ul>
                        ...
                        <!-- Delivery & Output -->
                        <div class="mega-menu-column">
                            <h4 style="font-size: 14px; font-weight: 600; text-transform: uppercase; color: #ff6b35; margin-bottom: 12px;">Delivery & Output</h4>
                            <ul>
            ...
            <div class="mega-menu" style="position: absolute; top: calc(100% + 12px); left: 50%; transform: translateX(-50%) translateY(-10px); width: 100vw; max-width: 1400px; min-width: 1200px; background: #1a1a1a; border-top: 2px solid #ff6b35; box-shadow: 0 10px 25px rgba(0,0,0,0.3); opacity: 0; visibility: hidden; transition: all 0.3s ease; z-index: 50; margin-top: 8px;">
                <div class="mega-menu-content" style="max-width: 1400px; margin: 0 auto; padding: 30px 40px;">
                    ...
                    <div class="grid grid-cols-3 gap-10" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 2.5rem;">
                        <!-- Column 1: TV & Film -->
                        <div class="mega-menu-column" style="border-right: 1px solid #333; padding-right: 2rem;">
                            <h4 style="font-size: 14px; font-weight: 600; text-transform: uppercase; color: #ff6b35; margin-bottom: 12px;">TV & Film Production</h4>
                            <ul>
                        ...
                        <div class="mega-menu-column" style="border-right: 1px solid #333; padding-right: 2rem;">
                            <h4 style="font-size: 14px; font-weight: 600; text-transform: uppercase; color: #ff6b35; margin-bottom: 12px;">Commercial & Corporate</h4>
                            <ul>
                        ...
                        <div class="mega-menu-column">
                            <h4 style="font-size: 14px; font-weight: 600; text-transform: uppercase; color: #ff6b35; margin-bottom: 12px;">Lifestyle & Creative</h4>
                            <ul>
            ...
            <div class="mega-menu" style="position: absolute; top: calc(100% + 12px); left: 50%; transform: translateX(-50%) translateY(-10px); width: 100vw; max-width: 1400px; min-width: 1200px; background: #1a1a1a; border-top: 2px solid #ff6b35; box-shadow: 0 10px 25px rgba(0,0,0,0.3); opacity: 0; visibility: hidden; transition: all 0.3s ease; z-index: 50; margin-top: 8px;">
                <div class="mega-menu-content" style="max-width: 1400px; margin: 0 auto; padding: 30px 40px;">
                    ...
                    <div class="grid grid-cols-3 gap-10" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 2.5rem;">
                        <!-- Creative Roles -->
                        <div class="mega-menu-column" style="border-right: 1px solid #333; padding-right: 2rem;">
                            <h4 style="font-size: 14px; font-weight: 600; text-transform: uppercase; color: #ff6b35; margin-bottom: 12px;">Creative Roles</h4>
                            <ul>
                        ...
                        <!-- Technical Roles -->
                        <div class="mega-menu-column" style="border-right: 1px solid #333; padding-right: 2rem;">
                            <h4 style="font-size: 14px; font-weight: 600; text-transform: uppercase; color: #ff6b35; margin-bottom: 12px;">Technical Roles</h4>
                            <ul>
                        ...
                        <!-- Support Roles -->
                        <div class="mega-menu-column">
                            <h4 style="font-size: 14px; font-weight: 600; text-transform: uppercase; color: #ff6b35; margin-bottom: 12px;">Support Roles</h4>
                            <ul>
