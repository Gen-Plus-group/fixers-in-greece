...
document.addEventListener('DOMContentLoaded', function() {
    ...
    `;
        ...
        // Load mobile navigation - FIXED VERSION
        const mobileNav = document.getElementById('mobile-navigation-content');
        if (mobileNav) {
            mobileNav.innerHTML = `
        <div class="space-y-0">
            <!-- Level 1: Main Navigation Items -->
            <a href="/" class="block px-4 py-3 text-white hover:text-greece-blue hover:bg-gray-800 transition-colors duration-200 border-b border-gray-700" data-nav="home">
                <span class="font-medium text-sm">HOME</span>
            </a>

            <a href="/about-us/" class="block px-4 py-3 text-white hover:text-greece-blue hover:bg-gray-800 transition-colors duration-200 border-b border-gray-700" data-nav="about">
            ...
            <div class="mobile-menu-item border-b border-gray-700">
                <button class="mobile-menu-toggle w-full px-4 py-3 text-left text-white hover:text-greece-blue hover:bg-gray-800 transition-colors duration-200 flex items-center justify-between" data-menu="preproduction">
                    <span class="font-medium text-sm">PRE-PRODUCTION</span>
            ...
            <div class="mobile-menu-item border-b border-gray-700">
                <button class="mobile-menu-toggle w-full px-4 py-3 text-left text-white hover:text-greece-blue hover:bg-gray-800 transition-colors duration-200 flex items-center justify-between" data-menu="production">
            ...
            <div class="mobile-menu-item border-b border-gray-700">
                <button class="mobile-menu-toggle w-full px-4 py-3 text-left text-white hover:text-greece-blue hover:bg-gray-800 transition-colors duration-200 flex items-center justify-between" data-menu="postproduction">
                    <span class="font-medium text-sm">POST-PRODUCTION</span>
                    <svg class="w-4 h-4 transition-transform duration-200 menu-chevron" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg>
                </button>
            ...
            <div class="mobile-menu-item border-b border-gray-700">
                <button class="mobile-menu-toggle w-full px-4 py-3 text-left text-white hover:text-greece-blue hover:bg-gray-800 transition-colors duration-200 flex items-center justify-between" data-menu="content">
                    <span class="font-medium text-sm">CONTENT PRODUCTION</span>
                    <svg class="w-4 h-4 transition-transform duration-200 menu-chevron" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg>
                </button>
            ...
            <div class="mobile-menu-item border-b border-gray-700">
                <button class="mobile-menu-toggle w-full px-4 py-3 text-left text-white hover:text-greece-blue hover:bg-gray-800 transition-colors duration-200 flex items-center justify-between" data-menu="crew">
                    <span class="font-medium text-sm">FILM CREW</span>
                    <svg class="w-4 h-4 transition-transform duration-200 menu-chevron" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg>
                </button>
            ...
            <div class="mobile-menu-item border-b border-gray-700">
                <button class="mobile-menu-toggle flex items-center justify-between w-full px-4 py-3 text-white hover:text-greece-blue hover:bg-gray-800 transition-colors duration-200"
                        data-submenu="filming-submenu"
                        aria-expanded="false">
                    <span class="font-medium text-sm">FILMING IN GREECE</span>
            ...
            <a href="/portfolio/" class="block px-4 py-3 text-white hover:text-greece-blue hover:bg-gray-800 transition-colors duration-200 border-b border-gray-700" data-nav="portfolio">
                <span class="font-medium text-sm">PORTFOLIO</span>
            </a>

            <a href="/contact/" class="block px-4 py-3 text-white hover:text-greece-blue hover:bg-gray-800 transition-colors duration-200 border-b border-gray-700" data-nav="contact">
