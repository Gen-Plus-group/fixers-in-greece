<?php
/**
 * Contact Form Handler for Fixers in Vietnam
...
$subject_prefix = '[Fixers Vietnam] New Production Enquiry';
...
<body>
    <div class="header">
        ...
        <p>Fixers in Vietnam - Professional Film Production Services</p>
    </div>
    ...
    <div class="content">
        ...
        <div class="section">
            ...
            <ul>
                ...
                <li>Send follow-up information about Vietnam filming</li>
            </ul>
        </div>
    </div>
    
    <div class="footer">
        <p>This enquiry was submitted through the Fixers in Vietnam website contact form.</p>
...
$text_message = "NEW PRODUCTION ENQUIRY - Fixers in Vietnam\n";
$text_message .= "==========================================\n\n";
...
$headers = [
    ...
    'From: Fixers Vietnam Website <' . $from_email . '>',
    'Reply-To: ' . $email,
...
$auto_reply_subject = 'Thank you for contacting Fixers in Vietnam';
$auto_reply_message = '
<!DOCTYPE html>
<html>
<head>
...
<body>
    ...
    <div class="content">
        ...
        <p>Thank you for contacting Fixers in Vietnam regarding your <strong>' . $project_type_text . '</strong> project.</p>
        ...
        <ul>
            ...
            <li>Information about filming in Vietnam</li>
            <li>Next steps for your production</li>
        </ul>
        
        <p>For urgent matters, please call us directly at <strong>+44 (0) 20 8549 2259</strong>.</p>
        
        <p>We look forward to helping make your Vietnam production a success!</p>
        
        <p>Best regards,<br>
        <strong>The Fixers in Vietnam Team</strong></p>
    </div>
    
    <div class="footer">
        <p>Fixers in Vietnam | Professional Film Production Services</p>
        <p>Email: enquiries@needafixer.com | Phone: +44 (0) 20 8549 2259</p>
        <p>Website: www.fixersinvietnam.com</p>
    </div>
</body>
</html>';
...
$auto_reply_headers = [
    'MIME-Version: 1.0',
    'Content-Type: text/html; charset=UTF-8',
    'From: Fixers Vietnam <' . $from_email . '>',
    'X-Mailer: PHP/' . phpversion()
];
